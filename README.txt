...
## Train models: (with customizable parameters including the scales variable which is the size of the UNets used in the model, and depth which is the number of iterations of the iterative method Forward Backward)
